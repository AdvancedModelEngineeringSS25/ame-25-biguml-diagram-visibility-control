 ...
 *********************************************************************************/
import { DiagramVisibilityControlModule } from '@borkdominik-biguml/big-diagram-visibility-control/vscode';
...
export function createContainer(
    ...
    container.load(
        ...
        DiagramVisibilityControlModule(VSCodeSettings.DiagramVisibilityControl.viewId),
        themeModule
    );
